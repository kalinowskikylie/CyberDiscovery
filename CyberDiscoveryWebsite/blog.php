<?php
	...
	$blogdbobj = select_txtdb('camps/'. $_SESSION[$session_prefix .'curCamp'] .'/blogdb.txt'); //Select and create blog database structure
...
<div style="display:none;" id="referer" name="blog" camp="<?php if(isset($_SESSION[$session_prefix .'curCamp'])){ echo($_SESSION[$session_prefix .'curCamp']);} ?>"></div>
...
<!-- ++++++++++++++++++++Editor for New Blog+++++++++++++++++++++++++++++++++++++ -->
		<div id="newblogeditor" class="blogpost" style="display:none;">
			<form action="bin/blog_upload.php" method="post" enctype="multipart/form-data">
...
<!-- +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->	
	...
	<div id="infocolumn">
		<h2>Newsfeed</h2>
		<p>Cyber Discovery Camp is a week long experience for high school students. They learn applicable life skills through instruction, self-creativity, and teamwork. Originally created at Louisiana Tech University, and now being deployed throughout the country, we proud to bring students this opportunity to enrich their academic background.</p>
	</div>
...
<div style="position:fixed; bottom:0px; right:20px; background-color:#CCC; padding:3px;" id="campswitcher">
	<form action="bin/process_campswitcher.php" method="post">
		...
		<input type="hidden" name="referringPage" value="/cyberdiscovery/blog.php" />
